...
def download_db():
    ...
    # if not os.path.exists("supplier-database.db"):
        # https://drive.google.com/file/d/1ko0J0niD4ZV3uEaZ3AY80gOJucOByh08/view?usp=sharing
    ...
    if not os.path.exists("supplier_database-v3.db"):
        gdown.download('https://drive.google.com/uc?id=1ko0J0niD4ZV3uEaZ3AY80gOJucOByh08', 'supplier_database-v3.db', quiet=False)
