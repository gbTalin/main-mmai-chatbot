...
# - Here we are loading the API keys from the .env file     #
# --------------------------------------------------------- #
...
# --------------------------------------------------------- #
# - Defining the database download function                 #
# - Function to download the .db file from Google Drive     #
...
def download_db():
    ...
    # if not os.path.exists("supplier-database.db"):
        # https://drive.google.com/file/d/10F5MWo_KGaU553q9k0-36rhTpHZj9E-v/view?usp=sharing
    ...
    if not os.path.exists("supplier_database-v3.db"):
        gdown.download('https://drive.google.com/uc?id=10F5MWo_KGaU553q9k0-36rhTpHZj9E-v', 'supplier_database-v3.db', quiet=False)
...
# - The database is used to query the businesses            #
# - The database connection is stored in the cache          #
# --------------------------------------------------------- #
@st.cache_resource()
...
# - The SQL query is generated based on the user's query    #
# - The SQL query is generated based on the chat history    #
# --------------------------------------------------------- #
...
# - Generate the NLP query from the uploaded PDF file       #
# --------------------------------------------------------- #
...
# --------------------------------------------------------- #
# - Function to get the PDF query                           #
# - Generate the query from the uploaded PDF file           #
# - Extract the service type/ oppurtunity type (SECTOR)     #
# - Required by the RFP, ignoring the rest of the content   #
# --------------------------------------------------------- #
...
# --------------------------------------------------------- #
# # Code Functions for MAP UI Generation and Clustering     #
# - Functions to generate the map UI                        #
# - Functions to cluster the businesses on the map          #
# --------------------------------------------------------- #
...
# --------------------------------------------------------- #
# - Function to find the closest and furthest pairs         #
# - Find the closest and furthest pairs of locations        #
# --------------------------------------------------------- #
...
# --------------------------------------------------------- #
# - Function to add a center marker to the map              #
# - Add a center marker to the map                          #
# --------------------------------------------------------- #
...
# --------------------------------------------------------- #
# - Function to add lines to the center                     #
# - Add lines to the center of the map                      #
# --------------------------------------------------------- #
...
# --------------------------------------------------------- #
# - Function to cluster the locations                       #
# - Cluster the locations using KMeans                      #
# --------------------------------------------------------- #
...
# - Add circle markers to the map for each centroid         #
# --------------------------------------------------------- #
...
# --------------------------------------------------------- #
# # Function to download generated business list as file    #
# - Download the generated business list as a CSV file      #
# --------------------------------------------------------- #
@st.fragment()
...
# --------------------------------------------------------- #
# # Functions for UI Component content formatting for o/p   #
# --------------------------------------------------------- #

# --------------------------------------------------------- #
# # Function to generate the AI response                    #
# - Generate the AI response for the chatbot                #
# --------------------------------------------------------- #
@st.fragment()
...
# --------------------------------------------------------- #
# # Function to generate the DataFrame content              #
# --------------------------------------------------------- #
@st.fragment()
def generate_df(df):
...
# --------------------------------------------------------- #
# # Function to generate the Map content                    #
# --------------------------------------------------------- #
@st.fragment()
...
# --------------------------------------------------------- #
# Instantiate the chat history if it doesn't exist          #
# --------------------------------------------------------- #
...
# --------------------------------------------------------- #
# Instantiate the chat display if it doesn't exist          #
# --------------------------------------------------------- #
...
# --------------------------------------------------------- #
# Instantiate the pdf query if it doesn't exist             #
# --------------------------------------------------------- #
...
# --------------------------------------------------------- #
# Loading the environment for streamlit functionality       #
# --------------------------------------------------------- #
load_dotenv()
# --------------------------------------------------------- #
...
# - Streamlit App UI Components for the Chatbot Assistant   #
# --------------------------------------------------------- #

# --------------------------------------------------------- #
# # Streamlit App UI Components - Setting the sidebar       #
# --------------------------------------------------------- #
with st.sidebar:
...
# --------------------------------------------------------- #
# # Streamlit App UI Components - Setting the main content  #
# --------------------------------------------------------- #


# --------------------------------------------------------- #
# # ST App UI Components - Setting the initial variables    #
# --------------------------------------------------------- #
...
# --------------------------------------------------------- #
# --------------------------------------------------------- #
# # ST App UI Components - Setting the Main Displayed UI    #
# --------------------------------------------------------- #
# --------------------------------------------------------- #
with tab1:
